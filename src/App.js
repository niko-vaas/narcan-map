// San Francisco Narcan Overdose Mapping App (Heatmap Toggle Restored)
...
const emsStations = [
  ...
  // ... include all other stations as before
];
      ...
      <LayersControl position="topright">
        ...
        <Overlay checked={showHeatmap} name="Overdose Heatmap">
          <LayerGroup eventHandlers={{
            add: () => setShowHeatmap(true),
            remove: () => setShowHeatmap(false)
          }}>
